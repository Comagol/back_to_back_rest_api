...
--   Date and Time:   00:15 Monday March 16, 2026
--   Exported By:     FRANCOMABELLA
--   Flashback:       0
--   Export Type:     Component Export
--   Manifest
--     PLUGIN: 395323718512077408
--   Manifest End
--   Version:         24.2.14
...
wwv_flow_imp_shared.create_plugin(
 p_id=>wwv_flow_imp.id(395323718512077408)
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(395324034576077410)
,p_plugin_id=>wwv_flow_imp.id(395323718512077408)
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(395324379130077410)
,p_plugin_id=>wwv_flow_imp.id(395323718512077408)
,p_attribute_scope=>'APPLICATION'
...
,p_attribute_type=>'TEXT'
,p_is_required=>false
,p_default_value=>'4C8ECBDAF4768C3BE0637203000AC8C0'
,p_display_length=>50
,p_max_length=>50
,p_is_translatable=>false
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(395324870497077411)
,p_plugin_id=>wwv_flow_imp.id(395323718512077408)
,p_attribute_scope=>'APPLICATION'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(395325713491077412)
,p_plugin_attribute_id=>wwv_flow_imp.id(395324870497077411)
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(395325237994077411)
,p_plugin_attribute_id=>wwv_flow_imp.id(395324870497077411)
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(397811410796790304)
,p_plugin_attribute_id=>wwv_flow_imp.id(395324870497077411)
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(395326278240077412)
,p_plugin_id=>wwv_flow_imp.id(395323718512077408)
,p_attribute_scope=>'APPLICATION'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(395326653699077412)
,p_plugin_attribute_id=>wwv_flow_imp.id(395326278240077412)
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(395327139575077413)
,p_plugin_attribute_id=>wwv_flow_imp.id(395326278240077412)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(395327604921077413)
,p_plugin_id=>wwv_flow_imp.id(395323718512077408)
,p_attribute_scope=>'APPLICATION'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(395328021787077413)
,p_plugin_id=>wwv_flow_imp.id(395323718512077408)
,p_attribute_scope=>'APPLICATION'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(395328455129077414)
,p_plugin_id=>wwv_flow_imp.id(395323718512077408)
,p_attribute_scope=>'APPLICATION'
...
,p_is_required=>false
,p_is_translatable=>false
,p_depending_on_attribute_id=>wwv_flow_imp.id(395328021787077413)
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(395328843373077414)
,p_plugin_id=>wwv_flow_imp.id(395323718512077408)
,p_attribute_scope=>'APPLICATION'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(351087185363533556)
,p_plugin_id=>wwv_flow_imp.id(395323718512077408)
,p_attribute_scope=>'APPLICATION'
...
,p_show_in_wizard=>false
,p_is_translatable=>false
,p_depending_on_attribute_id=>wwv_flow_imp.id(395326278240077412)
,p_depending_on_has_to_exist=>true
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(385020219555842821)
,p_plugin_id=>wwv_flow_imp.id(395323718512077408)
,p_attribute_scope=>'APPLICATION'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(385020720800845266)
,p_plugin_attribute_id=>wwv_flow_imp.id(385020219555842821)
,p_display_sequence=>10
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(385021160884847062)
,p_plugin_attribute_id=>wwv_flow_imp.id(385020219555842821)
,p_display_sequence=>20
,p_display_value=>'Derived from Application Item'
,p_return_value=>'APEX_ITEM'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(395329276281077415)
,p_plugin_id=>wwv_flow_imp.id(395323718512077408)
...
,p_is_required=>true
,p_is_translatable=>false
,p_depending_on_attribute_id=>wwv_flow_imp.id(395339225235077420)
,p_depending_on_has_to_exist=>true
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(395329613544077415)
,p_plugin_id=>wwv_flow_imp.id(395323718512077408)
,p_attribute_scope=>'COMPONENT'
,p_attribute_sequence=>2
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(395330491736077415)
,p_plugin_attribute_id=>wwv_flow_imp.id(395329613544077415)
,p_display_sequence=>10
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(395331005631077416)
,p_plugin_attribute_id=>wwv_flow_imp.id(395329613544077415)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(395331572250077416)
,p_plugin_attribute_id=>wwv_flow_imp.id(395329613544077415)
,p_display_sequence=>30
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(395332060917077416)
,p_plugin_attribute_id=>wwv_flow_imp.id(395329613544077415)
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(395332490754077417)
,p_plugin_attribute_id=>wwv_flow_imp.id(395329613544077415)
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(395333016345077417)
,p_plugin_attribute_id=>wwv_flow_imp.id(395329613544077415)
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(395329989113077415)
,p_plugin_attribute_id=>wwv_flow_imp.id(395329613544077415)
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(395333544959077417)
,p_plugin_id=>wwv_flow_imp.id(395323718512077408)
,p_attribute_scope=>'COMPONENT'
,p_attribute_sequence=>3
,p_display_sequence=>30
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(395333889735077417)
,p_plugin_id=>wwv_flow_imp.id(395323718512077408)
,p_attribute_scope=>'COMPONENT'
,p_attribute_sequence=>4
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(395338778953077420)
,p_plugin_attribute_id=>wwv_flow_imp.id(395333889735077417)
,p_display_sequence=>10
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(395335830951077419)
,p_plugin_attribute_id=>wwv_flow_imp.id(395333889735077417)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(395336261210077419)
,p_plugin_attribute_id=>wwv_flow_imp.id(395333889735077417)
,p_display_sequence=>30
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(395336769944077419)
,p_plugin_attribute_id=>wwv_flow_imp.id(395333889735077417)
,p_display_sequence=>40
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(395337730015077420)
,p_plugin_attribute_id=>wwv_flow_imp.id(395333889735077417)
,p_display_sequence=>60
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(395335356493077418)
,p_plugin_attribute_id=>wwv_flow_imp.id(395333889735077417)
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(395334809741077418)
,p_plugin_attribute_id=>wwv_flow_imp.id(395333889735077417)
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(395337185521077419)
,p_plugin_attribute_id=>wwv_flow_imp.id(395333889735077417)
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(374405224460772161)
,p_plugin_attribute_id=>wwv_flow_imp.id(395333889735077417)
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(395334378393077418)
,p_plugin_attribute_id=>wwv_flow_imp.id(395333889735077417)
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(195116722990661196)
,p_plugin_attribute_id=>wwv_flow_imp.id(395333889735077417)
,p_display_sequence=>70
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(106700382198794077)
,p_plugin_attribute_id=>wwv_flow_imp.id(395333889735077417)
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(385585765173070928)
,p_plugin_attribute_id=>wwv_flow_imp.id(395333889735077417)
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(385586151683071791)
,p_plugin_attribute_id=>wwv_flow_imp.id(395333889735077417)
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(385586492952072979)
,p_plugin_attribute_id=>wwv_flow_imp.id(395333889735077417)
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(385586898205073815)
,p_plugin_attribute_id=>wwv_flow_imp.id(395333889735077417)
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(385587359124074565)
,p_plugin_attribute_id=>wwv_flow_imp.id(395333889735077417)
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(32684298165953179)
,p_plugin_attribute_id=>wwv_flow_imp.id(395333889735077417)
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(32684693451954595)
,p_plugin_attribute_id=>wwv_flow_imp.id(395333889735077417)
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(32685074556956305)
,p_plugin_attribute_id=>wwv_flow_imp.id(395333889735077417)
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(197603529841708463)
,p_plugin_attribute_id=>wwv_flow_imp.id(395333889735077417)
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(197603853366707486)
,p_plugin_attribute_id=>wwv_flow_imp.id(395333889735077417)
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(197604259672706225)
,p_plugin_attribute_id=>wwv_flow_imp.id(395333889735077417)
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(248111117935565144)
,p_plugin_attribute_id=>wwv_flow_imp.id(395333889735077417)
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(281891456342725697)
,p_plugin_attribute_id=>wwv_flow_imp.id(395333889735077417)
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(395338245664077420)
,p_plugin_attribute_id=>wwv_flow_imp.id(395333889735077417)
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(395339225235077420)
,p_plugin_id=>wwv_flow_imp.id(395323718512077408)
,p_attribute_scope=>'COMPONENT'
,p_attribute_sequence=>5
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(395339667422077421)
,p_plugin_attribute_id=>wwv_flow_imp.id(395339225235077420)
,p_display_sequence=>10
,p_display_value=>'SQL'
,p_return_value=>'SQL'
,p_help_text=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(395340119668077421)
,p_plugin_attribute_id=>wwv_flow_imp.id(395339225235077420)
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(395340652869077421)
,p_plugin_attribute_id=>wwv_flow_imp.id(395339225235077420)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(395341135268077421)
,p_plugin_attribute_id=>wwv_flow_imp.id(395339225235077420)
,p_display_sequence=>30
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(395341642904077422)
,p_plugin_attribute_id=>wwv_flow_imp.id(395339225235077420)
,p_display_sequence=>40
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(389751646267135453)
,p_plugin_attribute_id=>wwv_flow_imp.id(395339225235077420)
,p_display_sequence=>50
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(389752042886136269)
,p_plugin_attribute_id=>wwv_flow_imp.id(395339225235077420)
,p_display_sequence=>60
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(391398147085142862)
,p_plugin_attribute_id=>wwv_flow_imp.id(395339225235077420)
,p_display_sequence=>70
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(395342119228077422)
,p_plugin_id=>wwv_flow_imp.id(395323718512077408)
,p_attribute_scope=>'COMPONENT'
,p_attribute_sequence=>6
,p_display_sequence=>10
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(389752727465141236)
,p_plugin_attribute_id=>wwv_flow_imp.id(395342119228077422)
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(233531164417077993)
,p_plugin_attribute_id=>wwv_flow_imp.id(395342119228077422)
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(233531645949079463)
,p_plugin_attribute_id=>wwv_flow_imp.id(395342119228077422)
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(395343038093077423)
,p_plugin_attribute_id=>wwv_flow_imp.id(395342119228077422)
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(395343517775077423)
,p_plugin_attribute_id=>wwv_flow_imp.id(395342119228077422)
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(395343998679077423)
,p_plugin_attribute_id=>wwv_flow_imp.id(395342119228077422)
,p_display_sequence=>10
,p_display_value=>'SQL'
,p_return_value=>'SQL'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(395342529941077422)
,p_plugin_attribute_id=>wwv_flow_imp.id(395342119228077422)
,p_display_sequence=>15
,p_display_value=>'PL/SQL Function (returning SQL)'
,p_return_value=>'PLSQL_SQL'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(395344561060077423)
,p_plugin_attribute_id=>wwv_flow_imp.id(395342119228077422)
,p_display_sequence=>20
,p_display_value=>'PL/SQL Function (returning JSON)'
,p_return_value=>'PLSQL'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(399881320903501454)
,p_plugin_attribute_id=>wwv_flow_imp.id(395342119228077422)
,p_display_sequence=>25
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(395345024732077424)
,p_plugin_attribute_id=>wwv_flow_imp.id(395342119228077422)
,p_display_sequence=>30
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(391388229923858270)
,p_plugin_attribute_id=>wwv_flow_imp.id(395342119228077422)
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(395345524573077424)
,p_plugin_attribute_id=>wwv_flow_imp.id(395342119228077422)
,p_display_sequence=>40
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(385027644129948841)
,p_plugin_attribute_id=>wwv_flow_imp.id(395342119228077422)
,p_display_sequence=>50
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(195114342547710517)
,p_plugin_attribute_id=>wwv_flow_imp.id(395342119228077422)
,p_display_sequence=>60
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(395346049534077424)
,p_plugin_id=>wwv_flow_imp.id(395323718512077408)
,p_attribute_scope=>'COMPONENT'
,p_attribute_sequence=>7
...
,p_is_required=>true
,p_is_translatable=>false
,p_depending_on_attribute_id=>wwv_flow_imp.id(395342119228077422)
,p_depending_on_has_to_exist=>true
,p_depending_on_condition_type=>'IN_LIST'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(395346404580077424)
,p_plugin_id=>wwv_flow_imp.id(395323718512077408)
,p_attribute_scope=>'COMPONENT'
,p_attribute_sequence=>8
...
,p_is_required=>false
,p_is_translatable=>false
,p_depending_on_attribute_id=>wwv_flow_imp.id(395333889735077417)
,p_depending_on_has_to_exist=>true
,p_depending_on_condition_type=>'EQUALS'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(395346821731077425)
,p_plugin_id=>wwv_flow_imp.id(395323718512077408)
,p_attribute_scope=>'COMPONENT'
,p_attribute_sequence=>9
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(395347195223077425)
,p_plugin_id=>wwv_flow_imp.id(395323718512077408)
,p_attribute_scope=>'COMPONENT'
,p_attribute_sequence=>10
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(395347631004077425)
,p_plugin_id=>wwv_flow_imp.id(395323718512077408)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(395348023873077426)
,p_plugin_id=>wwv_flow_imp.id(395323718512077408)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(395348468978077426)
,p_plugin_id=>wwv_flow_imp.id(395323718512077408)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(395348818179077426)
,p_plugin_id=>wwv_flow_imp.id(395323718512077408)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(395350729026077427)
,p_plugin_attribute_id=>wwv_flow_imp.id(395348818179077426)
,p_display_sequence=>10
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(395349756865077427)
,p_plugin_attribute_id=>wwv_flow_imp.id(395348818179077426)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(395350233061077427)
,p_plugin_attribute_id=>wwv_flow_imp.id(395348818179077426)
,p_display_sequence=>30
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(201682787240417072)
,p_plugin_attribute_id=>wwv_flow_imp.id(395348818179077426)
,p_display_sequence=>35
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(395349232374077426)
,p_plugin_attribute_id=>wwv_flow_imp.id(395348818179077426)
,p_display_sequence=>40
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(391387758524854401)
,p_plugin_attribute_id=>wwv_flow_imp.id(395348818179077426)
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(397581290624293324)
,p_plugin_attribute_id=>wwv_flow_imp.id(395348818179077426)
,p_display_sequence=>50
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(206061706579463488)
,p_plugin_attribute_id=>wwv_flow_imp.id(395348818179077426)
,p_display_sequence=>60
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(370232940213112987)
,p_plugin_attribute_id=>wwv_flow_imp.id(395348818179077426)
,p_display_sequence=>70
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(370233344463111255)
,p_plugin_attribute_id=>wwv_flow_imp.id(395348818179077426)
,p_display_sequence=>80
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(370233656409109494)
,p_plugin_attribute_id=>wwv_flow_imp.id(395348818179077426)
,p_display_sequence=>90
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(102700844484339140)
,p_plugin_attribute_id=>wwv_flow_imp.id(395348818179077426)
,p_display_sequence=>100
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(395351190080077428)
,p_plugin_id=>wwv_flow_imp.id(395323718512077408)
,p_attribute_scope=>'COMPONENT'
...
,p_is_required=>false
,p_is_translatable=>false
,p_depending_on_attribute_id=>wwv_flow_imp.id(395348818179077426)
,p_depending_on_has_to_exist=>true
,p_depending_on_condition_type=>'IN_LIST'
